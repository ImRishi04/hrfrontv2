document.addEventListener('DOMContentLoaded', () => {
    ...
    uploadButton.addEventListener('click', async () => {
        ...
        try {
            ...
            const response = await axios.post('https://serverver2.onrender.com/generate_questions', formData, {
        ...
        if (finalTranscription) {
            try {
                ...
                if (isFollowUp) {
                    ...
                    const response = await axios.post('https://serverver2.onrender.com/generate_follow_up', {
    ...
    concludeInterview.addEventListener('click', async () => {
        try {
            stopRecording();
            const response = await axios.post('https://serverver2.onrender.com/generate_feedback', {
    ...
    async function getTTSUrl(text) {
        try {
            ...
            const response = await axios.post('https://serverver2.onrender.com/tts', { text: cleanedText }, {
                responseType: 'blob'
            });
